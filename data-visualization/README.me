# Visualizing Gravitational Wave Detection

The data from LIGO, the gravitational wave detector in europe, can be converted into soundfiles. I used the soundfile from the first detection which came from a neutrino star collision. I downloaded the file from here: https://www.gw-openscience.org/audio/
